<?php
// does initial customer lookup; implements seconday lookup via jQuery DataTables
...
<script>
    $(document).ready(function() {
       $('#customerTable').DataTable({
           "ajax": '/php7cookbook/Application/chap_05/jquery_datatables_php_lookups_ajax.php?id=<?= $id ?>'
       }); 
    });
</script>
<style>
...
<body>
	...
	<table id="customerTable" class="display" callspacing="0" width="100%">
        <thead>
            <tr>
                <th>Transaction</th>
                <th>Date</th>
