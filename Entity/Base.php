...
class Base 
{
     ...
     * The reason why we pass an instance is in case we want to call this
     * methos in the constructor
     * 
     * @param array $data == assumes key are database column names
     ...
     * 
     * @return array $dataa == assumes keys are database colums names
     */
