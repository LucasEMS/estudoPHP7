...
{
    protected $selectedKeys = [self::DEFAULT_OPTION_KEY];
    
    /**
     * Assigns options to array of checkboxes
     * 
     * @param array $options = key => value pairs where key = "value" attrib and valur = what appears next to box
     * @param array $selectedKeys = [string  | int => default value | selected value(s)]
     * @param string $spaces = separator between box and text
