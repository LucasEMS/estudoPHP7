...
// http://php.net/manual/en/functions.arguments.php#funtions.arguments.type-declaration.strict
// if you wish to declare scalar type hints, it is *mandatory* to include the 
// following:
...
function someBooleanHint(bool $b)
{
    return $b;
}