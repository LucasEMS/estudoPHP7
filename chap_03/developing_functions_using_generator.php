...
include (__DIR__ . DIRECTORY_SEPARATOR . 'developing_functions_iterators_library.php');
...
// set up the code which will hoover a website looking for the "href" attibutes
