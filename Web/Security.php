...
class Security
{
     ...
     * Uses preg_match() to extract the 2nd part of the match, which should 
     * produce a key from $this->filter or $this->validate
     * 
     * @param string $method
     * @param mixed $params
     * @return mixed if $prefix == filter, returns tranformed value: 
