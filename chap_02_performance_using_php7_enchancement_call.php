...
define('LOG_FILES', 'C:\xampp\apache\logs\*access*.log');
...
foreach (glob(LOG_FILES) as $filename) {
    ...
    foreach ($access->fileIteratorByLine() as $line) {
        // calls the anonymous function, binfs $access to $this, and accepts
        // param $line
        $freq->call($access, $line);
        // To do the same thing in PHP 5 you would need these 2 line:
