...
class Paginate
{
     ...
     * 
     * @param mixes $sql  // this would be a good place to use Fincer::getSql()
     * @param int $page = the current "page" number
     * @param int $linesPerPage = how many lines fo you wnat to see on the page
     * @return string
     */
     ...
     */
    public function paginate(Connection $connection, $fetchMode,
            $params = array())
    {
        try {
